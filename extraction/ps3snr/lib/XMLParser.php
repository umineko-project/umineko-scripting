...
/**
 * Fixed for big xml files by vit9696
 *
 * @copyright Copyright (c) 2013, BesplSoft Team
 */
...
class XMLParser 
{
    ...
    */
     ...
     * @return XMLParser
     */
    function __construct($cleanTagNames = true)
    {
    ...
    public function Parse($filename)
    {
    	...
    	if (!$fh) trigger_error('XML Parsing Error: Failed to open input file');
...
class XMLTag
{
    ...
    /**
     * Converts quotes, amps and other symbols into their html replacements
     */
